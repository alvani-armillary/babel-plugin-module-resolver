...
function getRelativePath(sourcePath, currentFile, absFileInRoot, opts) {
  ...
  if (realSourceFileExtension !== sourceFileExtension) {
    relativePath = (0, _utils2.replaceExtension)(relativePath, opts);
  }

  return (0, _utils2.toLocalPath)((0, _utils2.toPosixPath)(relativePath));
}
...
function findPathInRoots(sourcePath, _ref) {
  ...
  root.some(function (basedir) {
    resolvedSourceFile = (0, _utils2.nodeResolvePath)(`./${sourcePath}`, basedir, extensions);
...
function checkIfPackageExists(modulePath, currentFile, extensions) {
  var resolvedPath = (0, _utils2.nodeResolvePath)(modulePath, currentFile, extensions);
...
function resolvePathFromAliasConfig(sourcePath, currentFile, opts) {
  ...
  if ((0, _utils2.isRelativePath)(aliasedSourceFile)) {
    return (0, _utils2.toLocalPath)((0, _utils2.toPosixPath)((0, _mapToRelative2.default)(opts.cwd, currentFile, aliasedSourceFile)));
  }
